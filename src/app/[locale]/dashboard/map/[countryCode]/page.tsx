    ...
    <div className="flex flex-col gap-8 p-6 md:p-10 max-w-[1600px] mx-auto min-h-screen">
      ...
      <div className="grid gap-8 grid-cols-1">
        ...
        <div className="grid gap-8 md:grid-cols-2">
          <CountryPieChart data={data.speciesData} title="Adoptions by Species" />
          <CountryPieChart data={data.platformData} title="Adoptions by Platform" />
        </div>

        {/* Breakdowns Row 2: Location Bar Charts */}
        <div className="grid gap-8 md:grid-cols-2">
          <CountryLocationBarChart data={data.stateData} title="Top 5 Regions/States" />
